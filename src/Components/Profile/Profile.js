...
export default function Profile() {
  return (
    <section id="profile" class="bg-white dark:bg-gray-900">
      <div class="grid max-w-screen-xl px-4 py-32 mx-auto lg:gap-8 xl:gap-0 lg:pt-32 pb-16 lg:grid-cols-12 h-108 ">
        ...
        <div class=" hidden lg:mt-0 lg:col-span-5 lg:flex px-20">
          <img src="Suit.jpg" class=" w-64 h-64 rounded-full" alt="Avatar" />
        </div>
      </div>
    </section>
    ...
    //                 {" "}
    //                 Hello I'm <span className='highlighted-text'>Paviru Perera</span>
    //             </span>
    //         </div>

    //         <div className='profile-details-role'>
    //             <span className='highlighted-text-cursor'>
    //                 <TypewriterComponent
    //                     options={{
    //                         strings: ['Aspiring Technology Consultant', 'Stategic Business Caser','Computer Science Student'],
    //                         autoStart: true,
    //                         loop: true,
    //                         delay: 75
    //                     }}
    ...
    //                 NTU Renaissance Engineering Programme Scholar
    //             </span>
    //         </div>

    //         <div className='profile-options'>
    //                 <div className='resume-button'>
    //                     <a href="Paviru_Perera_Resume.pdf" download={"Paviru_Perera_Resume.pdf"} className='resume-btn'>
    ...
    //                     <a href='https://www.linkedin.com/in/paviru-perera-920966251/'>
    ...
    //             <img src='SPDC.jpg' alt="Avatar" class="avatar"></img>
    //         </div>
    //     </div>
    // </div>
  );
